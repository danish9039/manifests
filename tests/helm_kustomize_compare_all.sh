...
declare -A COMPONENT_SCENARIOS=(
    ...
    ["kubeflow-trainer"]="crds platform"
)
...
if [[ "$COMPONENT" == "all" ]]; then
    ...
    for comp in katib hub kserve-models-web-app kubeflow-trainer; do
    ...
    echo "  kubeflow-trainer       Test Kubeflow Trainer scenarios"
    echo ""
    echo "Examples:"
    ...
    echo "ERROR: Unknown component: $COMPONENT"
    echo "Supported components: katib, hub, kserve-models-web-app, kubeflow-trainer, all"
