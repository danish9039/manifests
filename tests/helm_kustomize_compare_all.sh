...
if [[ "$COMPONENT" == "all" ]]; then
    ...
    for comp in katib hub kserve-models-web-app kserve; do
    ...
    echo "  kserve                 Test KServe scenarios"
    echo ""
    echo "Examples:"
    ...
    echo "ERROR: Unknown component: $COMPONENT"
    echo "Supported components: katib, hub, kserve-models-web-app, kserve, all"
