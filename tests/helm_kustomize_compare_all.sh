...
if [[ "$COMPONENT" == "all" ]]; then
    ...
    for comp in katib hub kserve-models-web-app knative-serving; do
    ...
    echo "  knative-serving        Test Knative Serving scenarios"
    echo ""
    echo "Examples:"
    ...
    echo "ERROR: Unknown component: $COMPONENT"
    echo "Supported components: katib, hub, kserve-models-web-app, knative-serving, all"
