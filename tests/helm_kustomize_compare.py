...
def get_resource_key(manifest: Dict, component: str = "katib") -> str:
    ...
    # Include namespace in key for components that render namespaced resources.
    if component in ["katib", "kubeflow-trainer"] and namespace:
...
def get_expected_helm_extras(component: str, scenario: str) -> set:
    ...
    if component == "katib":
        ...
        return set()
    elif component == "kubeflow-trainer":
        return set()
    else:
        return set()
...
if __name__ == "__main__":
    if len(sys.argv) < 5:
        ...
        print("Components: katib, hub, kserve-models-web-app, kubeflow-trainer")
        sys.exit(1)
    ...
    if component not in ["katib", "hub", "kserve-models-web-app", "kubeflow-trainer"]:
        print(f"ERROR: Unknown component: {component}")
        print("Supported components: katib, hub, kserve-models-web-app, kubeflow-trainer")
        sys.exit(1)
