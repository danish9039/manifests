...
def get_resource_key(manifest: Dict, component: str = "katib") -> str:
    ...
    # multiple namespaces.
    if component in ["katib", "kserve"] and namespace:
...
if __name__ == "__main__":
    if len(sys.argv) < 5:
        ...
        print("Components: katib, hub, kserve-models-web-app, kserve")
        sys.exit(1)
    ...
    if component not in ["katib", "hub", "kserve-models-web-app", "kserve"]:
        print(f"ERROR: Unknown component: {component}")
        print("Supported components: katib, hub, kserve-models-web-app, kserve")
        sys.exit(1)
