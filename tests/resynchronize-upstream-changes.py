...
path_to_synchronization_script = {
    ...
    "applications/pipeline/helm/Chart.yaml": "scripts/synchronize-pipelines-manifests.sh",
    "applications/pipeline/helm/manifests": "scripts/synchronize-pipelines-manifests.sh",
