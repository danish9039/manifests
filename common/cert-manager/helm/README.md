...
```bash
python3 tests/run_helm_kustomize_comparison.py cert-manager base
python3 tests/run_helm_kustomize_comparison.py cert-manager kubeflow
python3 tests/run_helm_kustomize_comparison.py cert-manager existing-cert-manager
```
